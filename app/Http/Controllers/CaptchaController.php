...
<<<<<<< HEAD
    ...
    public function captcha()
    {
        ...
        // Bagian pertama UUID sebagai token
        $token = explode('-', $uuid)[0];

        // Bagian terakhir UUID sebagai CAPTCHA code, diambil 6 karakter
        $captchaCode = substr(explode('-', $uuid)[4], 0, 6);

        // Simpan CAPTCHA code dalam cache dengan token sebagai kunci
        Cache::put($token, $captchaCode, 300); 
=======
    // private function generateRandomString($length = 6)
    // {
    //     $characters = '0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ';
...
>>>>>>> 1dfbcb5ad3453544b5e8f2bfddcf3da521cccb49
